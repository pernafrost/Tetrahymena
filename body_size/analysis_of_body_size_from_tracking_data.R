...
fileName <- "/Users/perna/Dropbox/tetrahymena_results/tracking_results/speed_response_2021/track_analysis_results_individual_particles.csv" # file.choose() # ask the user to select a file name.
