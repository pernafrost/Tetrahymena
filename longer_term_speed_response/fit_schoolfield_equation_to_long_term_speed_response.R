...
for (aaa in 1:length(allTAdaptation))
{
  ...
  for (mmm in 1:length(allMediumConcentrations))
  {
    ...
    for (lll in 1:length(allLines))
    {
      ...
      # Impose a minimum th to see if we can force a better fit on the first plot
      # which automatically picked a very low temperature for the switch to deactivation
      # low_lims[[4]]=30
      # print("CAREFUL!!!! look for  low_lims[[4]]=27.5")
      # Sys.sleep(5)
      ...
      if (includeBootstrap)
      {
        ...
        if (is.null(fit))
        {
          startingValues <- c(500, 0.1, 20, 37)
      ...
      {
        # predict new data
        new_data <- data.frame(temp = seq(min(currentConditionTopSpeed$tTest), max(currentConditionTopSpeed$tTest), 0.5))
        preds <- augment(fit, newdata = new_data)
...
if(saveFigures)
{
  if (combineLinesTogether)
  {
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation_all.png", dpi = 600, width = 24, height = 20, units = "cm")
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation_all.eps", device="eps", dpi = 1200, width = 24, height = 20, units = "cm")
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation_all.pdf", device=cairo_pdf, dpi = 1200, width = 24, height = 20, units = "cm")
    
  }  else {
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation.png", dpi = 600, width = 24, height = 20, units = "cm")
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation.eps", device="eps", dpi = 1200, width = 24, height = 20, units = "cm")
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation.pdf", device=cairo_pdf, dpi = 1200, width = 24, height = 20, units = "cm")
  }
}
...
if (combineLinesTogether == FALSE)
{
  ...
  if(saveFigures)
  {
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation2.png", dpi = 600, width = 24, height = 20, units = "cm")
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation2.eps", device="eps", dpi = 1200, width = 24, height = 20, units = "cm")
    library(Cairo)
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation2.pdf", device=cairo_pdf, dpi = 1200, width = 24, height = 20, units = "cm")
  }
  ...
  if (saveFigures)
  {
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation3.png", dpi = 600, width = 24, height = 20, units = "cm")
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation3.eps", device="eps", dpi = 1200, width = 24, height = 20, units = "cm")
    library(Cairo)
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation3.pdf", device=cairo_pdf, dpi = 1200, width = 24, height = 20, units = "cm")
  }
  ...
  if (saveFigures)
  {
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation4.png", dpi = 600, width = 24, height = 20, units = "cm")
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation4.eps", device="eps", dpi = 1200, width = 24, height = 20, units = "cm")
    library(Cairo)
    ggsave(file="figure_speed_long_term_thermal_response_post_adaptation4.pdf", device=cairo_pdf, dpi = 1200, width = 24, height = 20, units = "cm")
  }
...
ggplot(allFitResults, aes(x=tAdaptation, y=e_from_fit, color=factor(mediumConcentration), shape=factor(mediumConcentration), label=factor(line))) +
  ...
  scale_x_continuous(name="Temperature (ºC)") +
  theme_classic(base_size=15) +
  #theme(legend.position = "none") +
...
ggplot(allFitResults, aes(x=tAdaptation, y=topt, color=factor(mediumConcentration), shape=factor(mediumConcentration), label=factor(line))) +
  ...
  #theme(legend.position = "none") +
  labs(color = "Conc.") + # this specifies a custom legend
  ggtitle("Optimal temperature from Stokes power")
...
# plot data and model fit
ggplot(allFitResultsOnSpeed, aes(x=tAdaptation, y=e_from_fit, color=factor(mediumConcentration), shape=factor(mediumConcentration), label=factor(line))) +
  # geom_point(size=6) +
...
if (saveFigures){
  if (combineLinesTogether){
    ggsave(file="figure_activation_energy_on_speed_long_term_all.png", dpi = 600, width = 12, height = 10, units = "cm")
    ggsave(file="figure_activation_energy_on_speed_long_term_all.eps", device="eps", dpi = 1200, width = 12, height = 10, units = "cm")
    library(Cairo)
    ggsave(file="figure_activation_energy_on_speed_long_term_all.pdf", device=cairo_pdf, dpi = 1200, width = 12, height = 10, units = "cm")
  } else {
    ggsave(file="figure_activation_energy_on_speed_long_term.png", dpi = 600, width = 12, height = 10, units = "cm")
    ggsave(file="figure_activation_energy_on_speed_long_term.eps", device="eps", dpi = 1200, width = 12, height = 10, units = "cm")
    library(Cairo)
    ggsave(file="figure_activation_energy_on_speed_long_term.pdf", device=cairo_pdf, dpi = 1200, width = 12, height = 10, units = "cm")
...
# plot data and model fit
ggplot(allFitResultsOnSpeed, aes(x=tAdaptation, y=topt, color=factor(mediumConcentration), shape=factor(mediumConcentration), label=factor(line))) +
  # geom_point(size=6) +
  geom_jitter(size=4, position = position_jitter(height = 0, width = .3)) + 
  # geom_text(color="black", size=4) + 
  scale_color_manual(values=c("#A3A3A3", "#666666", "#000000")) +
...
if (saveFigures){
  if (combineLinesTogether){
    ggsave(file="figure_optimal_temp_vs_temp_on_speed_long_term_all.png", dpi = 600, width = 12, height = 10, units = "cm")
    ggsave(file="figure_optimal_temp_vs_temp_on_speed_long_term_all.eps", device="eps", dpi = 1200, width = 12, height = 10, units = "cm")
    library(Cairo)
    ggsave(file="figure_optimal_temp_vs_temp_on_speed_long_term_all.pdf", device=cairo_pdf, dpi = 1200, width = 12, height = 10, units = "cm")
  } else {
    ggsave(file="figure_optimal_temp_vs_temp_on_speed_long_term.png", dpi = 600, width = 12, height = 10, units = "cm")
    ggsave(file="figure_optimal_temp_vs_temp_on_speed_long_term.eps", device="eps", dpi = 1200, width = 12, height = 10, units = "cm")
    library(Cairo)
    ggsave(file="figure_optimal_temp_vs_temp_on_speed_long_term.pdf", device=cairo_pdf, dpi = 1200, width = 12, height = 10, units = "cm")
...
# plot data and model fit
ggplot(allFitResultsOnSpeed, aes(x=tAdaptation, y=r_tref, color=factor(mediumConcentration), shape=factor(mediumConcentration), label=factor(line))) +
  # geom_point(size=4) +
  geom_jitter(size=4, position = position_jitter(height = 0, width = .3)) + 
  # geom_text(color="black", size=4) + 
  scale_color_manual(values=c("#A3A3A3", "#666666", "#000000")) +
...
{
  if (combineLinesTogether){
    ggsave(file="figure_speed_long_term_at_tref_long_term_all.png", dpi = 600, width = 12, height = 10, units = "cm")
    ggsave(file="figure_speed_long_term_at_tref_long_term_all.eps", device="eps", dpi = 1200, width = 12, height = 10, units = "cm")
    # quartz(type = 'pdf', file="aaaa_metabolic_thermal_response_post_adaptation.pdf")
    library(Cairo)
    ggsave(file="figure_speed_long_term_at_tref_long_term_all.pdf", device=cairo_pdf, dpi = 1200, width = 12, height = 10, units = "cm")
  } else {
    ggsave(file="figure_speed_long_term_at_tref_long_term.png", dpi = 600, width = 12, height = 10, units = "cm")
    ggsave(file="figure_speed_long_term_at_tref_long_term.eps", device="eps", dpi = 1200, width = 12, height = 10, units = "cm")
    library(Cairo)
    ggsave(file="figure_speed_long_term_at_tref_long_term.pdf", device=cairo_pdf, dpi = 1200, width = 12, height = 10, units = "cm")
  ...
  
{
  ...
  if (saveFigures){
    if (combineLinesTogether){
      ggsave(file="figure_activation_energy_on_speed_long_term_bootstrap_all.png", dpi = 600, width = 12, height = 10, units = "cm")
      ggsave(file="figure_activation_energy_on_speed_long_term_bootstrap_all.eps", device="eps", dpi = 1200, width = 12, height = 10, units = "cm")
      library(Cairo)
      ggsave(file="figure_activation_energy_on_speed_long_term_bootstrap_all.pdf", device=cairo_pdf, dpi = 1200, width = 12, height = 10, units = "cm")
    } else {
      ggsave(file="figure_activation_energy_on_speed_long_term_bootstrap.png", dpi = 600, width = 12, height = 10, units = "cm")
      ggsave(file="figure_activation_energy_on_speed_long_term_bootstrap.eps", device="eps", dpi = 1200, width = 12, height = 10, units = "cm")
      library(Cairo)
      ggsave(file="figure_activation_energy_on_speed_long_term_bootstrap.pdf", device=cairo_pdf, dpi = 1200, width = 12, height = 10, units = "cm")
  ...
  {
    if (combineLinesTogether){
      ggsave(file="figure_speed_long_term_at_tref_bootstrap_all.png", dpi = 600, width = 12, height = 10, units = "cm")
      ggsave(file="figure_speed_long_term_at_tref_bootstrap_all.eps", device="eps", dpi = 1200, width = 12, height = 10, units = "cm")
      library(Cairo)
      ggsave(file="figure_speed_long_term_at_tref_bootstrap_all.pdf", device=cairo_pdf, dpi = 1200, width = 12, height = 10, units = "cm")
    } else {
      ggsave(file="figure_speed_long_term_at_tref_bootstrap.png", dpi = 600, width = 12, height = 10, units = "cm")
      ggsave(file="figure_speed_long_term_at_tref_bootstrap.eps", device="eps", dpi = 1200, width = 12, height = 10, units = "cm")
      library(Cairo)
      ggsave(file="figure_speed_long_term_at_tref_bootstrap.pdf", device=cairo_pdf, dpi = 1200, width = 12, height = 10, units = "cm")
...
if (saveFigures){
  if (combineLinesTogether)
  {
    ggsave(file="figure_fitted_speed_long_term_vs_temp_all.png", dpi = 600, width = 12, height = 10, units = "cm")
    ggsave(file="figure_fitted_speed_long_term_vs_temp_all.eps", device="eps", dpi = 1200, width = 12, height = 10, units = "cm")
    library(Cairo)
    ggsave(file="figure_fitted_speed_long_term_vs_temp_all.pdf", device=cairo_pdf, dpi = 1200, width = 12, height = 10, units = "cm")
  } else {
